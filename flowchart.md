...
C --> C4[Train-Test Split and Data Leakage]
...
D1c --> D1d[Ridge and Lasso Regression]
D1d --> D1e[Elastic Net]
D1e --> D1f[Regularization Concepts]
D1f --> D1g[Evaluation Metrics - RMSE, MAE, R2 Score]
...
D2e --> D2f[XGBoost and LightGBM and CatBoost]
D2f --> D2g[Naive Bayes]
...
G --> G1[Regularization - L1 and L2]
G --> G2[Feature Importance and Selection]
G --> G3[Learning Curves and Overfitting Control]

%% DEEP LEARNING %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
G3 --> H[Deep Learning]
H --> H1[Neural Network Basics - Perceptron, Forward and Backpropagation]
...
H5 --> H6[RNN and LSTM - Sequential Data]
...
I3a --> I3b[Prompt Engineering, LLMs - ChatGPT, Gemini]

%% DEPLOYMENT & MLOPS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
I3b --> J[Model Deployment and MLOps]
